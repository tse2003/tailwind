...
export function AboutMe() {
    return <div className="bg-gray-50">
        ...
        <div className="lg:flex">
            <div className="lg:about2">
                <div className="photoback2"></div>
                <img className="photo2" src="Pic2.png"/>
            </div>
            <div className="lg:about1">
                <h1 className="font-bold text-2xl mt-10 flex gap-2 justify-center">
                ...
                <div className="textSpace">
                    ...
                    <p className="text-sm mt-4 text-gray-600 ml-24">
                    ...
                    <div className="flex gap-16 ml-5 mt-4 text-gray-600">
                        <div className="ml-24">
                            <ul className="list">
